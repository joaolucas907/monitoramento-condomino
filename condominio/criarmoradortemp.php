        ...
        <form id="form" method="POST" enctype="multipart/form-data">
                ...
                <h1 class="mt-4">Cadastro</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Morador Temporario</li>
                        </ol>
                <div class="card-content-cadastro">
                        ...
                        <div class="card-content-area-cadastro">
                            ...
                            <label for="senhanv">Senha novamente</label>

                            <input type="password" id="senhanv" name="senhanv" autocomplete="off" required>
                        ...
                        <div class="card-content-area-cadastro">
                            ...
                            <input type="text" id="tempo" name="tempo" autocomplete="off" required>
...
<script type="text/javascript">
    ...
    $.ajax({
       url: "acoes/cadastro/moradortemp.php",
        type: 'POST',
        data: formData,
