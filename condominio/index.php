            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Monitoramento</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <table id="datatablesSimple">
                                    ...
                                    <tbody>
                            <?php
                                $sql_morador = "SELECT * FROM cadastro where situacao = 'ativado' ";         
                                ...
                                ?>          
                                            ...
                                            <tr>
                                                    ...
                                                    <td><a href="#"><div onclick="abrirmodal('<?=$id?>')" class="<?=$monitoramento?>"><?=$monitoramento?></a></td>
                                            </tr>
...
function abrirmodal(id){
    $.ajax({
                url: "modal/mudarmonitoramentomorador.php",
                method: "post",
                data: {id},
                dataType: "html",
